...
#Top left plot
plot(Datetime_dataset,Dataset$Global_active_power,ylab = "Global Active Power",lty = 1,type="l",xlab="")
#Top right plot
plot(Datetime_dataset,Dataset$Voltage,ylab = "Voltage",lty = 1,type="l",xlab="datetime")
#Bottom left plot
...
legend("topright",legend=Names_dataset[7:9], lty=1, col=c("black","red","blue"),bty = "n")
#Bottom right plot
plot(Datetime_dataset,Dataset$Global_reactive_power,ylab = "Global_reactive_power",lty = 1,type="l",xlab="datetime")
